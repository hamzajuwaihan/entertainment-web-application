  ...
  <div className="col-lg-12">
    ...
    <div className="row">
      <div className="col-lg-4">
        <div className="item">
          <div className="icon">
            <img src="./user/assets/images/service-01.jpg" alt style={{maxWidth: 60, borderRadius: '50%'}} />
          </div>
      ...
      <div className="col-lg-4">
        <div className="item">
          <div className="icon">
            <img src="./user/assets/images/service-02.jpg" alt style={{maxWidth: 60, borderRadius: '50%'}} />
          </div>
      ...
      <div className="col-lg-4">
        <div className="item">
          <div className="icon">
            <img src="./user/assets/images/service-03.jpg" alt style={{maxWidth: 60, borderRadius: '50%'}} />
          </div>
          <h4>You Are Live</h4>
